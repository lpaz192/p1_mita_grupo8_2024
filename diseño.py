...
mostrar_publicacion = lambda id_post, fecha, likes, comentarios, id_usuario, usuario: print(f"│ {id_post:<10} │ {fecha:<18} │ {likes:<8} │ {comentarios:<13} │ {id_usuario:<10} │ {usuario:<18} │")
